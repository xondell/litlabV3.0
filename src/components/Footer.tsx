        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <nav className="flex flex-col gap-2" aria-label="Footer navigation">
              ...
              <Link href="/catalog" className="text-sm font-semibold text-gray-600 hover:text-black transition-colors">
                Catalog
              </Link>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm font-semibold text-gray-600">
              ...
              <div className="flex gap-3 mt-2">
                <a
                  href="#"
                  className="w-9 h-9 rounded-full border-2 border-gray-300 flex items-center justify-center hover:bg-black hover:text-white hover:border-black transition-colors"
                  aria-label="Twitter"
                >
                  𝕏
                </a>
                <a
                  href="#"
                  className="w-9 h-9 rounded-full border-2 border-gray-300 flex items-center justify-center hover:bg-black hover:text-white hover:border-black transition-colors text-xs font-black"
